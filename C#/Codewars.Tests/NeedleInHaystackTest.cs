namespace Codewars.Tests
{
    ...
    public class NeedleInHaystackTest
    {
        ...
        public void GenericTests()
        {
            ...
            ClassicAssert.AreEqual("found the needle at position 3", Kata.FindNeedle(haystack_1));
            ClassicAssert.AreEqual("found the needle at position 5", Kata.FindNeedle(haystack_2));
            ClassicAssert.AreEqual("found the needle at position 30", Kata.FindNeedle(haystack_3));
        }
    }
}
